...
public class ObraEntity {
    ...
    public ObraEntity(Long id, String nombre, String empresaContratista, LocalDate fechaInicio, LocalDate fechaTermino, boolean esPublico, int metrosCuadrados, int estado, String direccion){
        this.id = id;
        this.nombre = nombre;
