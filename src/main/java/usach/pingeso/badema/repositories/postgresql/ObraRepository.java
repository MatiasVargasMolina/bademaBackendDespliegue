...
public interface ObraRepository extends JpaRepository<ObraEntity, Long> {
    ...
    /*
        SELECT new usach.pingeso.badema.dtos.obra.ObraListDTO(o.id, o.nombre, o.empresaContratista, o.fechaInicio, o.fechaTermino, o.esPublico, o.metrosCuadrados, )
        FROM UsuarioObraEntity uo AND ObraEntity o WHERE uo.usuario.isGerencia = false AND uo.obra.id = o.id AND ou.usuario.id = :idUsuario;
     */

    @Query("SELECT new usach.pingeso.badema.entities.ObraEntity(o.id, o.nombre, o.empresaContratista, o.fechaInicio, " +
            "o.fechaTermino, o.esPublico, o.metrosCuadrados, o.estado) " +
